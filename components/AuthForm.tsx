            ...
            <header className='flex flex-col gap-5 md:gap-8'>
                <Link href="/" className="cursor-pointer flex items-center gap-1">
                    <Image
                        ...
                        alt="Clyra logo"
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Clyra</h1>
                </Link>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className='flex gap-4'>
                                    <CustomInput
                                        control={form.control} name='city' label="City" placeholder="Ex: Hull"
                                    />
                                    <CustomInput
                                        control={form.control} name='postCode' label="Post Code" placeholder="Ex: HU61RX"
                                    />
                                    </div>
                                    <CustomInput
